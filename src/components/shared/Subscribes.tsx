...
const Subscribes = () => {
  ...
  return (
    <section className="my-16 flex w-full flex-col-reverse items-center justify-around bg-lime-200 py-5 text-black md:flex-row">
      <div className="flex flex-col gap-3 px-4 text-center capitalize md:px-0 md:text-left">
        <h1 className="w-full px-6 text-lg font-bold leading-snug md:w-80 md:px-0 md:text-xl">
          subscribe now to get useful traveling information
        </h1>
        <div className="dark:bg-primaryDark mx-auto flex h-10 w-full max-w-96 items-center justify-between rounded-lg border border-black/30 bg-white px-1 md:mt-4">
          <input
            type="email"
        ...
        <p className="w-full max-w-96 text-xs">
